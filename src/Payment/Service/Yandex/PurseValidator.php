...
/**
 * Class YandexPurseValidator
 * todo make validation through yandex.money api as more accuracy method to know is it valid purse
 */
class PurseValidator
{
    /**
     ...
     */
    public function validate($purseNum) : bool
    {
        ...
        $checkSum = $this->accountNumberRedundancy($purseX, $purseY);
        if($checkSum !== $purseZ){
            return false;
        }
        return true;
     ...
     */
    function accountNumberRedundancy($processingCode, $accountCode): string
    {
        /**
